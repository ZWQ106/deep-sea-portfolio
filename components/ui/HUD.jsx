...
export default function HUD() {
  return (
    <div style={{
        position: 'fixed', right: '40px', bottom: '40px', zIndex: 9999, pointerEvents: 'none',
        display: 'flex', alignItems: 'flex-end', gap: '20px', color: 'white', fontFamily: "'Courier New', monospace"
      }}>
